...
void Encrypt(const uint8_t* message, uint8_t* encrypted_message);
...
static void
L_Reverse(const uint8_t *in_data, uint8_t *out_data)
{
    int i;
    vect internal;
    memcpy(internal, in_data, BLOCK_SIZE);
...
void Decrypt(const uint8_t* encrypted_message, uint8_t* decrypted_message)
{
